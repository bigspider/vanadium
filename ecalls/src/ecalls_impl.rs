...
ecall7!(display_blit, ECALL_DISPLAY_BLIT, (dst: u32), (size: u32), (buffer: *const u8), (buffer_len: usize), (src: u32), (src_stride: u32), (format: u32), i32);
ecall3!(display_refresh, ECALL_DISPLAY_REFRESH, (pos: u32), (size: u32), (mode: u32), i32);
ecall3!(display_fill_rect, ECALL_DISPLAY_FILL_RECT, (pos: u32), (size: u32), (color: u32), i32);
ecall7!(display_draw_text, ECALL_DISPLAY_DRAW_TEXT, (pos: u32), (size: u32), (text: *const u8), (text_len: usize), (font: u32), (color: u32), (bg: u32), i32);
