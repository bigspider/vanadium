...
delegate_ecall!(display_fill_rect, i32, (pos: u32), (size: u32), (color: u32));
delegate_ecall!(display_draw_text, i32, (pos: u32), (size: u32), (text: *const u8), (text_len: usize), (font: u32), (color: u32), (bg: u32));
delegate_ecall!(display_text_width, i32, (font: u32), (text: *const u8), (text_len: usize));
delegate_ecall!(display_font_metrics, i32, (font: u32));
